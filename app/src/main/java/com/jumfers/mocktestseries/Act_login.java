...
public class Act_login extends AppCompatActivity {
    ...
    private String Ename,Email,Epass;
    @Override
    ...
    private void signIn() {
        ...
        if (user != null) {
            ...
            String password = user.getDisplayName().trim();
            Log.d("APPLICATION","email: "+email+" password: "+password);
            progress_circular.setVisibility(View.VISIBLE);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                    ...
                                    makeVolleyRequest(Act_login.this,name,email,"1234578890", Objects.requireNonNull(name).trim());
                                }else {
                                    Log.d("APPLICATION","NAME: "+name+" email: "+email);
