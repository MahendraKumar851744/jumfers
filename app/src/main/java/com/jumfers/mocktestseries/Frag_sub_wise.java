...
//        makeVolleyRequest(getContext(),category_id,subcategory_id);
        ...
        PapersListViewModelFactory factory = new PapersListViewModelFactory(requireActivity().getApplication(), category_id,subcategory_id,SUB_PAPERS_LIST);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                for(int i=0;i<data.length();i++){
                                    ...
                                    arrayList.add(new Paper_Count(model.getString("id"),category_id,subcategory_id,model.getString("title"),model.getString("paper_count"),2));
                                }
