...
public class Model {
    ...
    private com.jumfers.mocktestseries.databases.questions_db.Options options;
    ...
    public Model(int question_id, String question, com.jumfers.mocktestseries.databases.questions_db.Options options, String is_right, String detail, String selected, String selected_answer, String time) {
        this.question_id = question_id;
    ...
    public com.jumfers.mocktestseries.databases.questions_db.Options getOptions() {
        return options;
    }
