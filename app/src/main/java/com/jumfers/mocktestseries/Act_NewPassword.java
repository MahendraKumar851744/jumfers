...
public class Act_NewPassword extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if(password.getText().toString().contains(" ")){
                    ...
                    if(password.getText().toString().equals(confirm_password.getText().toString())){
                        ...
                        makeVolleyRequest(Act_NewPassword.this,email,password.getText().toString(),confirm_password.getText().toString());
    ...
    public void makeVolleyRequest(Context context,String email,String pass,String conf_pass){
